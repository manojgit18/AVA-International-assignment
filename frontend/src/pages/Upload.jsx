  ...
  async function handleUpload() {
    ...
    try {
      const res = await axios.post(
        `${API}/api/upload/?user_id=demo-user`, form
      )
      setResult(res.data)
    } catch (e) {
        ...
        <div style={{ marginTop: 28 }}>
          ...
          {result?.extracted?.vendor_name || result?.extracted?.total_amount ? (
            <div style={{
              ...
              color: "#16a34a", fontWeight: 600, marginBottom: 20,
            }}>
            ...
            <div style={{
              ...
              color: "#854d0e", fontWeight: 600, marginBottom: 20,
            }}>
              ...
              <div key={label} style={{
                ...
                <div style={{ fontWeight: 600, marginTop: 4, fontSize: 15 }}>
                  {value !== null && value !== undefined
                    ? value
                    : <span style={{ color: "#9ca3af", fontWeight: 400 }}>Not found</span>
                  }
                </div>
              </div>
            ))}
